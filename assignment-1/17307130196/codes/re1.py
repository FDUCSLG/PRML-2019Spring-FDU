...
print('H:')
#num,K,bins,K,h,N
main.main('H',1000,50,20,0.8,100)
main.main('H',1000,50,20,0.8,500)
main.main('H',1000,50,20,0.8,1000)
main.main('H',1000,50,20,0.8,10000)

# print('K:')
# main.main('K',1000,50,20,0.01,100)
# main.main('K',1000,50,20,0.01,500)
# main.main('K',1000,50,20,0.01,1000)
# main.main('K',1000,50,20,0.01,10000)
