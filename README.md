...
* Please use the issue system to ask questions about the coursework and course, use proper tags whenever possible, (e.g. `assignment-1`). In this case any questions answered by the instructor, TAs or others will also be valuable for other students.
